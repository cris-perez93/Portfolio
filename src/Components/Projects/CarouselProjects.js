        ...
        <div className="container_image_project">
          ...
          <div className="hover_container">
            ...
            <div className="details">
                ...
                <p>Proyect with React, Redux, React-Router, REST API, and Axios.
                Redux is a predictable state container designed to help you write JavaScript apps that behave consistently across client, server, and native environments and are easy to test.</p>
                <div className="icons">
        ...
        <div className="container_project">
           ...
           <div className="hover_container">
              ...
              <div className="details">
                ...
                <p>
                  Widget with search form with several fields.
                  The cars available for rental are shown below.
                  For this project I have used React-Redux for a better centralization of the state.
                </p>
                <div className="icons">
              
                <a className="icon" href="https://github.com/cris-perez93/rent-cars" target="_blank" rel="noreferrer"><i className="fab fa-github" aria-hidden="true"></i></a>
                <a className="icon" href="https://cris-perez93.github.io/rent-cars/" target="_blank" rel="noreferrer"><p>Demo</p></a>
              </div>
         ...
         <div className="container_project">
           ...
           <div className="hover_container">
              ...
              <div className="details">
                ...
                <p>Layout for a movie website, using React and and axios for call API movies.
                Using css flexbox and adding logic to the visualization of the score obtained according to critics. </p>
                <div className="icons">
          ...
          <div className="container_project">
            ...
            <div className="details">
                  ...
                  <p>Small form to manage a weekly / monthly budget, adding and subtracting expenses.React-Hooks</p>
                  <div className="icons">
